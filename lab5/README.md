# Lab 5
# PPO on MiniGrid Dynamic Obstacles

### Instructions:
The code is configured for MiniGrid-Dynamic-Obstacles-5x5-v0 and trains successfully. Scale the environment to 8x8 or 16x16 and make the agent learn successfully.
...
### Objectives:
* Identify reward misalignment as a cause of RL failure, even when PPO is implemented correctly.
* Understand how reward sparsity and longer horizons hinder exploration in larger environments.
* Apply simple reward shaping to enable successful learning at scale.
